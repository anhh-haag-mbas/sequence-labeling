...
\textit{TensorFlow models were trained on the both the data and the padding.} This led
...
\textit{Maybe some of the things in \emph{Discrepancies} could be moved here? Or
it could be deleted/merged with \emph{Discrepancies}/\emph{Improvements}}.
...
this may be interesting to research further.
