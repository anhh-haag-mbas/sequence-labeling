...
theirs on~\ref{Someone else, see their source code}. The loss function for the
CRF model is not the negative log likelihood. The reference implementation used
uses the instance score of the forward algorithm minus the gold score of the
sentence. The influence this may have had one the results are unclear.
