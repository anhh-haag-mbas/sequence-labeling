...
improve the estimate and result in better, but slower training \cite{goldberg2016deep}.
...
results in better generalization ~\cite{goldberg2016deep}. The lower mini-batch
