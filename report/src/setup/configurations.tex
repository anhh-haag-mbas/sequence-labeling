...
\cite{huang2015bidirectional}. While this emperically seems to
...
improve the estimate and result in better, but slower training~\cite{goodfellow2016deep}.
...
results in better generalization~\cite{goodfellow2016deep}. The lower mini-batch
