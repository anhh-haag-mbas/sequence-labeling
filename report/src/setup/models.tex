...
100004 and produces an output of 64. The size of each LSTM in the Bi-LSTM layer
is 64 x 100, the output of each LSTM is concatenated giving us a 200 dimensional
output. The size of the simple linear layer is 200 x number of tags, depending
on the task. With CRF the last layer contains 2 additional tags because of an
...
than Polyglot's. There are exist many different algorithms for training word
